        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/projects/school/light-show',
                component: ComponentCreator('/docs/projects/school/light-show', '7b8'),
                exact: true,
                sidebar: "projectsSidebar"
              },
              {
              ...
              {
                path: '/docs/projects/school/tic-tac-toe',
                component: ComponentCreator('/docs/projects/school/tic-tac-toe', '42d'),
                exact: true,
                sidebar: "projectsSidebar"
              },
              {
