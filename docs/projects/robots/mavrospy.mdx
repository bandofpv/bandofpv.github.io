...
Being able to simulate in any robotics project and especially for UAVs is very important if you want to avoid damaging hardware. With ROS fully integrated into our system, we can easily use the [Gazebo Simulator](https://gazebosim.org/home) to simulate our UAV.
