...
Being able to simulate in any robotics project and especially for UAVs is very important if you want to avoid damaging hardware. With ROS fully integrated into our system, we can easily use [Gazebo](https://gazebosim.org/home) or [Isaac Sim](https://docs.isaacsim.omniverse.nvidia.com/latest/index.html) to simulate our UAV.
...
<Tabs groupId="ros-version">
  <TabItem value="ros2" label="Gazebo">
    <div className="video_wrapper">
  ...
  <TabItem value="isaac" label="Isaac Sim">
    <div className="video_wrapper">
        <ReactPlayer className="video_player" controls height="100%" width="100%" url="https://youtu.be/d7AmFjH5aL8?si=T_fx0aftsSm2Ir_D"/>
    </div>
  </TabItem>
</Tabs>
