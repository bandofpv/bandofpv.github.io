...
The demonstration video for GPS Navigation was displayed at the [Video](mavrospy/#video) section.
...
Being able to simulate in any robotics project and especially for UAVs is very important if you want to avoid damaging hardware. With ROS fully integrated into our system, we can easily use the [Gazebo Simulator](https://gazebosim.org/) to simulate our UAV.

First, we need to simulate a PX4 flight controller on a computer. Luckily, PX4 makes this very easy as its source code is all [open-source](https://github.com/PX4/PX4-Autopilot) and can be compiled on almost any system. We can then use MAVROS to integrate the simualted flight controller into ROS and MAVROSPY to maneuver our simulated drone:
