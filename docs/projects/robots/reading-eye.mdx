...
:::info
Check out my website tutorial **[HERE](../../tutorials/robots/reading-eye.mdx)**
:::
...
<div align="center">
![Fig. 4 Andrew Bernas](../../assets/robots/reading-eye/page1.jpg)
</div>
...
<div align="center">
$\large x_{distorted} = x(1+k_1r^2+k_2r^4+k_3r^6)$

$\large y_{distorted} = y(1+k_1r^2+k_2r^4+k_3r^6)$

$\large x_{distorted} = x+[2p_1xy+p_2(r^2+2x^2)]$

$\large y_{distorted} = y+[p_1(r^2+2y^2)+2p_2xy]$
</div>

In total the algorithm uses 5 parameters known as distortion coefficients: 

<div align="center">
$\large k_1\:k_2\:p_1\:p_2\:k_3$
</div>

which are dependent on the type of lens and image sensor you have. The undistorted image can be seen below.

<div align="center">
![Fig. 8 Andrew Bernas](../../assets/robots/reading-eye/page2.jpg)
</div>
...
<div align="center">
![Fig. 12 Andrew Bernas](../../assets/robots/reading-eye/line-segmentation.jpg)
</div>
...
<div align="center">
![Fig. 13 Andrew Bernas](../../assets/robots/reading-eye/deslanting.jpg)
</div>
...
<div align="center">
![Fig. 14 Andrew Bernas](../../assets/robots/reading-eye/database-example.jpg)
</div>
...
<div align="center">
![Fig. 14 Andrew Bernas](../../assets/robots/reading-eye/crnn.jpg)
</div>
