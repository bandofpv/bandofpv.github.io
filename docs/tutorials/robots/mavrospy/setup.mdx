...
MAVROSPY is supported on a PX4 (v1.15.4) flight controller with a RPi4 (Ubuntu 22.04 MATE), Jetson Nano (JetPack 4.6), or Jetson Orin Nano (JetPack 6.2) companion computer. Additionally, it supported on ROS2 Humble and ROS1 Noetic.
...
If you haven't already, please install [Ubuntu MATE 22.04](https://releases.ubuntu-mate.org/22.04/arm64/) for the RPi4 (arm64), [JetPack 4.6](https://developer.nvidia.com/embedded/jetpack-sdk-46) for the Jetson Nano, or [JetPack 6.2](https://developer.nvidia.com/embedded/jetpack-sdk-62) using the [Raspberry Pi Imager](https://www.raspberrypi.com/software/).
