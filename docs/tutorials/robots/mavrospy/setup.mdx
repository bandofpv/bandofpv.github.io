...
If you haven't already, please install [JetPack 6.2](https://developer.nvidia.com/embedded/jetpack-sdk-62) for the Jetson Orin Nano, [JetPack 4.6](https://developer.nvidia.com/embedded/jetpack-sdk-46) for the Jetson Nano, or [Ubuntu MATE 22.04](https://releases.ubuntu-mate.org/22.04/arm64/) for the RPi4 (arm64), using the [Raspberry Pi Imager](https://www.raspberrypi.com/software/).
