...
**[GitHub Repository](https://github.com/bandofpv/SAR_Drone)**
...
<div align="center">
![story Andrew Bernas](../../assets/robots/sar-drone/story.jpg)
</div>
...
<div align="center">
![sar1 Andrew Bernas](../../assets/robots/sar-drone/cover.jpg)
</div>

## Demo Video

<div className="video_wrapper">
    <ReactPlayer className="video_player" controls height="100%" width="100%" url="https://youtu.be/deG4v4odLUE"/>
</div>

## Code

Please clone my GitHub [repository](https://github.com/bandofpv/Search-and-Rescue-Drone) to follow along with this tutorial.

## Components List

|Qty|Component|
|:---|:---|
|x1|[Holybro Pixhawk 4 Autopilot + Neo-M8N GPS + PM07 Combo](https://www.hackster.io/products/buy/88718?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[Google Coral USB Accelerator](https://www.hackster.io/products/buy/42977?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[Raspberry Pi 4 Model B](https://www.hackster.io/products/buy/61211?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[FrSky X8R 16ch Receiver](https://www.hackster.io/products/buy/88721?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[3 Axis Brushless Camera Gimbal](https://www.hackster.io/products/buy/88722?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[Lumenier N2O 3500mAh 4s 120c Lipo Battery](https://www.hackster.io/products/buy/88723?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[32GB Micro SD Card](https://www.hackster.io/products/buy/88724?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[DJI Flame Wheel F450 Basic Quadcopter Drone Kit](https://www.hackster.io/products/buy/88750?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x2|[SunnySky X2212 KV980 Brushless Motors CW](https://www.hackster.io/products/buy/88725?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x2|[SunnySky X2212 KV980 Brushless Motors](https://www.hackster.io/products/buy/88726?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x4|[TURNIGY Plush 30amp Speed Controller w/BEC](https://www.hackster.io/products/buy/88727?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[Raspberry Pi Camera Module V2](https://www.hackster.io/products/buy/37274?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[TBS Unify Pro 5G8 V3 (SMA)](https://www.hackster.io/products/buy/88729?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[Lumenier CM-650 Mini - 650TVL Camera](https://www.hackster.io/products/buy/88730?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[TBS Triumph 5.8GHz RHCP FPV Antenna Set (SMA)](https://www.hackster.io/products/buy/88731?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[10x4.5 Propellers](https://www.hackster.io/products/buy/88732?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[XT60 Connectors With Pigtails](https://www.hackster.io/products/buy/88733?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[RunCam RC25G FPV Lens](https://www.hackster.io/products/buy/88734?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[5V UBEC](https://www.hackster.io/products/buy/88735?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
|x1|[Telemetry Cable for Smart Port Radios](https://www.hackster.io/products/buy/88791?s=BAhJIhM0MDkxNTYsUHJvamVjdAY6BkVG%0A)|
...
<div align="center">
![config1 Andrew Bernas](../../assets/robots/sar-drone/config1.jpg)
</div>

You will want to turn on the Camera, SSH, and Serial via this menu:

<div align="center">
![config2 Andrew Bernas](../../assets/robots/sar-drone/config2.jpg)
</div>
...
:::note
From now on, always ensure your in the **sar** virtual environment. If your not, use this command:
...
<div align="center">
![parrot Andrew Bernas](../../assets/robots/sar-drone/parrot.jpg)
</div>
...
```bash
$ git clone https://github.com/bandofpv/Search-and-Rescue-Drone
```

Navigate to the Search-and-Rescue-Drone repository and run the test program:
...
<div align="center">
![schematic1 Andrew Bernas](../../assets/robots/sar-drone/schematic1.jpg)
</div>
...
<div align="center">
![sar2 Andrew Bernas](../../assets/robots/sar-drone/sar2.jpg)
</div>
...
<div align="center">
![sar3 Andrew Bernas](../../assets/robots/sar-drone/sar3.jpg)
</div>

<div align="center">
![sar4 Andrew Bernas](../../assets/robots/sar-drone/sar4.jpg)
</div>
...
<div align="center">
![sar5 Andrew Bernas](../../assets/robots/sar-drone/sar5.jpg)
</div>

<div align="center">
![sar6 Andrew Bernas](../../assets/robots/sar-drone/sar6.jpg)
</div>

<div align="center">
![sar7 Andrew Bernas](../../assets/robots/sar-drone/sar7.jpg)
</div>

The RPI is mounted in the front part of the top side of the bottom plate, while the Coral TPU is on the back side:

<div align="center">
![sar8 Andrew Bernas](../../assets/robots/sar-drone/sar8.jpg)
</div>

<div align="center">
![sar9 Andrew Bernas](../../assets/robots/sar-drone/sar9.jpg)
</div>

:::note
Make sure to plug in the USB-C cable for the Coral TPU into the RPI's blue USB 3 port
:::

The GPS module and antennas are all mounted straight up and kept as far apart from each other to minimize interference:

<div align="center">
![sar10 Andrew Bernas](../../assets/robots/sar-drone/sar10.jpg)
</div>

The battery strap and battery foam pads are also mounted on the top plate

:::note
Make sure that the arrow on the GPS module is aligned forward and aligned with the flight controller.
:::
...
<div align="center">
![schematic2 Andrew Bernas](../../assets/robots/sar-drone/schematic2.png)
</div>
...
<div align="center">
![schematic3 Andrew Bernas](../../assets/robots/sar-drone/schematic3.jpg)
</div>
...
<div align="center">
![schematic4 Andrew Bernas](../../assets/robots/sar-drone/schematic4.jpg)
</div>
...
<div align="center">
![schematic5 Andrew Bernas](../../assets/robots/sar-drone/schematic5.jpg)
</div>
...
<div align="center">
![pinout Andrew Bernas](../../assets/robots/sar-drone/pinout.jpg)
</div>

:::tip
Pin 6 is ground, pin 8 is TX, and pin 10 is RX
:::
...
<div align="center">
![gimbal1 Andrew Bernas](../../assets/robots/sar-drone/gimbal1.jpg)
</div>
...
<div align="center">
![gimbal2 Andrew Bernas](../../assets/robots/sar-drone/gimbal2.jpg)
</div>
...
<div align="center">
![gimbal3 Andrew Bernas](../../assets/robots/sar-drone/gimbal3.jpg)
</div>
...
<div align="center">
![gimbal4 Andrew Bernas](../../assets/robots/sar-drone/gimbal4.jpg)
</div>
...
<div align="center">
![gimbal5 Andrew Bernas](../../assets/robots/sar-drone/gimbal5.jpg)
</div>

Navigate to the **Rc Inputs** tab:

<div align="center">
![gimbal6 Andrew Bernas](../../assets/robots/sar-drone/gimbal6.jpg)
</div>
...
<div align="center">
![gimbal7 Andrew Bernas](../../assets/robots/sar-drone/gimbal7.jpg)
</div>
...
:::tip
When configuring the flight modes, its important to at least have **Stabilize**, **Guided**, and **RTL** modes. **Stabilize** will be needed to take manual control of the aircraft, **Guided** is the mode which allows the RPI to take control over the copter, and **RTL** is just nice to have as a safety mechanism.
:::
...
<div align="center">
![ardupilot1 Andrew Bernas](../../assets/robots/sar-drone/ardupilot1.jpg)
</div>
...
<div align="center">
![ardupilot2 Andrew Bernas](../../assets/robots/sar-drone/ardupilot2.jpg)
</div>

<div align="center">
![ardupilot3 Andrew Bernas](../../assets/robots/sar-drone/ardupilot3.jpg)
</div>
...
<div align="center">
![telemetry1 Andrew Bernas](../../assets/robots/sar-drone/telemetry1.jpg)
</div>
...
<div align="center">
![telemetry5 Andrew Bernas](../../assets/robots/sar-drone/telemetry5.jpg)
</div>
...
<div align="center">
![telemetry6 Andrew Bernas](../../assets/robots/sar-drone/telemetry6.jpg)
</div>

Next, click on the **Downloads** button:

<div align="center">
![telemetry7 Andrew Bernas](../../assets/robots/sar-drone/telemetry7.jpg)
</div>

In the pop up window, click on the **Download firmware** button and save the .bin file:

<div align="center">
![telemetry8 Andrew Bernas](../../assets/robots/sar-drone/telemetry8.jpg)
</div>
...
<div align="center">
![telemetry9 Andrew Bernas](../../assets/robots/sar-drone/telemetry9.jpg)
</div>
...
<div align="center">
![telemetry10 Andrew Bernas](../../assets/robots/sar-drone/telemetry10.jpg)
</div>

After flashing the radio, copy the contents in this [folder](https://github.com/bandofpv/Search-and-Rescue-Drone/tree/master/SD) to your radio SD card.

Turn on your radio and navigate to the **Display** page and assign **yaapu9** to **Screen 1** of type **Script**:

<div align="center">
![telemetry11 Andrew Bernas](../../assets/robots/sar-drone/telemetry11.jpg)
</div>
...
<div align="center">
![telemetry12 Andrew Bernas](../../assets/robots/sar-drone/telemetry12.jpg)
</div>

Your second telemetry screen should now look like this:

<div align="center">
![telemetry13 Andrew Bernas](../../assets/robots/sar-drone/telemetry13.jpg)
</div>
...
```bash
workon sar
python /home/pi/Search-and-Rescue-Drone/takeoff_test.py
```
...
```bash
workon sar
python /home/pi/Search-and-Rescue-Drone/square_movement_test.py
```
...
```bash
workon sar
python /home/pi/Search-and-Rescue-Drone/record_test.py \
--model /home/pi/Search-and-Rescue-Drone/mobilenet_ssd_v2/mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite \
--labels /home/pi/Search-and-Rescue-Drone/mobilenet_ssd_v2/coco_labels.txt
```
...
On the RPI, you will notice that there is a file in the **Search-and-Rescue-Drone** repository called: **output.mp4**. Open it and you will notice that its the recording. Make sure that the camera was able to detect you in the recording.
...
```bash
workon sar
python /home/pi/Search-and-Rescue-Drone/main.py \
--model /home/pi/Search-and-Rescue-Drone/mobilenet_ssd_v2/mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite \
--labels /home/pi/Search-and-Rescue-Drone/mobilenet_ssd_v2/coco_labels.txt
```
