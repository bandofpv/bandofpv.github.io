...
const papers = [
  {
    ...
    authors: 'Bernas, A., Jess, N., DeVries, L., McConnell, J., Costello, D.',
    venue: 'AIAA SciTech Forum, 2026',
    link: 'https://doi.org/10.2514/6/6.2026-1123',
...
function Research() {
  return (
    <Layout title="Research Papers" description="My published research papers">
              ...
              <div className="card shadow--md" style={{width: '100%', display: 'flex', flexDirection: 'column'}}>
                ...
                <div className="card__body" style={{paddingTop: '0.25rem', paddingBottom: '0.25rem', flexGrow: 1}}>
                  <div className="margin-bottom--sm">
                    <strong>Authors:</strong> <span className="text--italic">{paper.authors}</span>
                  </div>
